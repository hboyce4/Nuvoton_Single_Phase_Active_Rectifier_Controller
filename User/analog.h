...
#define V_AC_OFFSET (ADC_RES_COUNT/2)*EADC_OVERSAMPLING	 			/* [ADC counts] Initial offset of the AC voltage front end. Will be auto-zeroed */
...
#define I_PV_OFFSET (ADC_RES_COUNT/2)*EADC_OVERSAMPLING			/* [ADC counts] Initial offset of the current process value (actual current). Will be auto-zeroed */
